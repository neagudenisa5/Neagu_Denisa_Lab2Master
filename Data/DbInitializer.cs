...
namespace Neagu_Denisa_Lab2.Data
{
    public class DbInitializer
    {
        public static void Initialize(LibraryContext context)
        {
            ...
            {
             new Order{BookID=1,CustomerID=1050,OrderDate=DateTime.Parse("2020-03-20")},
             new Order{BookID=3,CustomerID=1045,OrderDate=DateTime.Parse("2020-03-15")},
             new Order{BookID=1,CustomerID=1045,OrderDate=DateTime.Parse("2020-08-20")},
             new Order{BookID=2,CustomerID=1050,OrderDate=DateTime.Parse("2021-03-29")},
             new Order{BookID=4,CustomerID=1050,OrderDate=DateTime.Parse("2019-04-20")},
             new Order{BookID=6,CustomerID=1050,OrderDate=DateTime.Parse("2019-03-28")},
            };
